...
DEBUG_LOG = True if os.environ.get(
    "DEBUG_LOG") != None and os.environ["DEBUG_LOG"].lower() == "on" else False
...
BOT_INVITE_URL = f"https://discord.com/api/oauth2/authorize?client_id={DISCORD_CLIENT_ID}&permissions=534723951680&scope=bot%20applications.commands"
